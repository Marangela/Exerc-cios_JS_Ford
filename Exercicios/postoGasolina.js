...
const quantidade = parseFloat(prompt("Quantos litros de Alcool você deseja?"));
...
switch (tipo) {
    case "A":
        ...
        if (quantidade <= 20) {
            ...
            alert(`O valor com desconto é de ${comDescontoAlcool.toFixed(2)} você economizou
             ${descontoAlcool.toFixed(2)}`);
            ...
            alert(`O valor com desconto acima de 20 litros é de ${comDescontoAlcool}
             você economizou ${descontoAlcool.toFixed(2)}`);
    ...
    case "G":
        ...
        if (quantidadeGasolina <= 20) {
            ...
            totalGasolina = valorGasolina * quantidadeGasolina;
            let descontoGasolina = totalGasolina * 0.06;
            let comDesconto = totalGasolina - descontoGasolina;
